...
! function(d, h, k) {
    XF.activate ? console.error("XF core has been double loaded") : (XF.browser || (XF.browser = {
            ...
            xfUniqueId: function() {
                var a = this.attr("id");
                a || (a = "js-XFUniqueId" + XF.getUniqueCounter(),
                    this.attr("id", a));
                return a
            },
                    ...
                    switch (b.css("position")) {
                        ...
                        case "-webkit-sticky":
                            var c = b.dimensions(!0),
                                ...
                                e = b.css("top"),
                                g = b.css("bottom");
                            if ("auto" !== e && (e = c.top - f.top - parseInt(e, 10), .5 >= e && -.5 <= e) || "auto" !== g &&
                                (e = c.bottom - f.bottom - parseInt(g, 10), .5 >= e && -.5 <= e)) return a = b, !1
                    }
                });
                return a
            },
                    ...
                    if (0 >= w) c[e](g), k();
                        ...
                        if (c.css("transition-property").match(/(^|\s|,)-xf-(width|height)($|\s|,)/)) {
                            ...
                            var t = f[k],
                                ...
                                r = c.data(z),
                                x = n.style,
                                y = x.transition || x["-webkit-transition"] || x["-moz-transition"] || x["-o-transition"] || "",
                                u;
                            if (void 0 === r)
                                for (r = {}, u = 0; u < t.length; u++) r[t[u]] = x[t[u]] || "";
                            if (0 == c[k]())
                                for (u in B = "0", A) A.hasOwnProperty(u) && (A[u] = "0");
                            c.data(z, r).css("transition", "none")[e](g);
                            t = c.css(t);
                            r = t[k];
                            if (0 == c[k]())
                                for (u in r = "0", t) t.hasOwnProperty(u) && (t[u] = "0");
                            c[h](g);
                            if (B != r) {
                                var C = m;
                                c.css(A);
            ...
            isElementVisible: function(a) {
                ...
                return 0 <= a.top && 0 <= a.left && a.bottom <= d(h).height() && a.right <=
                    d(h).width()
            },
            ...
            updateAvatars: function(a, b, c) {
                d(".avatar").each(function() {
                    ...
                    if ((c || !e.hasClass(".js-croppedAvatar")) && e.is('[class^="' + g + '"]')) {
                        if (e.hasClass(g +
                                "s")) e = d(b.s);
                        else if (e.hasClass(g + "m")) e = d(b.m);
                        else if (e.hasClass(g + "l")) e = d(b.l);
                        else if (e.hasClass(g + "o")) e = d(b.o);
                        else return;
                        f.html(e.html());
            ...
            badgeCounterUpdate: function(a, b) {
                a.length && (a.attr("data-badge", b),
                    "0" != String(b) ? a.addClass("badgeContainer--highlighted") : a.removeClass("badgeContainer--highlighted"))
            },
            ...
            appBadgeUpdate: function(a) {
                "setAppBadge" in navigator && !navigator.webdriver && !navigator.userAgent.match(/Chrome-Lighthouse|Googlebot|AdsBot-Google|Mediapartners-Google/i) && (a = parseInt(String(a).replace(/[,. ]/g, "")), navigator.setAppBadge(a))
            },
            ...
            hideTooltips: function() {
                d.each(XF.TooltipTrigger.cache,
                    function(a, b) {
                        b.hide()
                    })
            },
            ...
            loadScripts: function(a, b) {
                ...
                function f() {
                    for (var a; h[0] && "loaded" == h[0].readyState;) a = h.shift(), a.onreadystatechange = null, a.onerror = null, l.appendChild(a), c()
                }
                var e = k.scripts[0],
                    g = "async" in e;
                e = e.readyState;
                ...
                for (q in a)
                    if (a.hasOwnProperty(q)) {
                        var p = a[q];
                        XF.loadedScripts[p] || (XF.loadedScripts[p] = !0, m++, g ? function(a) {
                                var b = d("<script>").prop({
                                    src: a,
                                    async: !1
                                });
            ...
            ajax: function(a, b, c, f, e) {
                ...
                var g = !0,
                    l = !0,
                    m = !0;
                e && (e.skipDefault && (l = g = !1, delete e.skipDefault), e.skipDefaultSuccessError && (l = !1, delete e.skipDefaultSuccessError), e.skipDefaultSuccess && (g = !1, delete e.skipDefaultSuccess),
                    e.skipError && (m = !1, delete e.skipError));
            ...
            defaultAjaxSuccessError: function(a, b, c) {
                ...
                return a.errorHtml ? (XF.setupHtmlInsert(a.errorHtml,
                    function(a, b) {
                    ...
                    if (c) {
                        ...
                        if (f) {
                            ...
                            d.each(f, function(a, b) {
                                "number" === typeof a ? q.push(XF.regexQuote(d.trim(b))) : q.push(XF.regexQuote(d.trim(a)))
                            });
                            q.length && (l = new RegExp("^(" + q.join("|") + ")(\\[|$)"))
                        }
                        a.each(function(a, b) {
                            (a = b.name) && "_xf" !== a.substring(0, 3) ? !l || l.test(a) ? m.push(b) : k.push(b) : k.push(b)
                        });
                        g = d(k).serializeArray();
                        f = d(m).serializeJSON();
                        g.unshift({
                            name: c,
            ...
            setupHtmlInsert: function(a, b, c) {
                ...
                if ("object" == typeof a && a.content) {
                    ...
                    XF.Loader.load(a.js, a.css, function() {
                        ...
                        if (m) {
                            ...
                            if (!h)
                                for (; c = XF.scriptMatchRegex.exec(l);) {
                                    var k = !1;
                                    if (q = c[1].match(/(^|\s)type=("|'|)([^"' ;]+)/)) switch (q[3].toLowerCase()) {
                        ...
                        var n = d(m ? d.parseHTML(l, null, h) : l);
                        n.retinaFix();
            ...
            applyDataOptions: function(a, b, c) {
                var f = {},
                    e;
                for (e in a)
                    if (a.hasOwnProperty(e) && (f[e] = a[e], b.hasOwnProperty(e))) {
                        var g = b[e];
                        var l = typeof g;
                        var m = !0;
                        switch (typeof f[e]) {
            ...
            logRecentEmojiUsage: function(a) {
                ...
                c = c ? c.split(",") : [];
                var f = c.indexOf(a); - 1 !== f && c.splice(f, 1);
                c.push(a);
            ...
            autoFocusWithin: function(a, b, c) {
                ...
                f.length || (!f.length && XF.NavDeviceWatcher.isKeyboardNav() && (f = a.find("a, button, :input, [tabindex]").filter(":visible").not(":disabled, [data-no-auto-focus]").first()), f.length || (b = a.is("form:not([data-no-auto-focus])") ? a : a.find("form:not([data-no-auto-focus])").first(), b.length && (f = b.find(":input, button").filter(":visible").not(":disabled, .select2-hidden-accessible").first())),
                    !f.length && c && c.length && (f = c), f.length || (a.attr("tabindex", "-1"), f = a));
                f = f.first();
                a = [];
                c = f[0].parentNode;
                do a.push({
                ...
                f.first().autofocus();
                for (b = 0; b < a.length; b++) c = a[b].el, c.scrollLeft != a[b].left && (c.scrollLeft = a[b].left), c.scrollTop != a[b].top &&
                    (c.scrollTop = a[b].top)
            },
            ...
            addFixedMessage: function(a, b) {
                ...
                b && (b.class &&
                    (c.addClass(b.class), delete b.class), c.attr(b));
            ...
            smoothScroll: function(a, b, c, f) {
                ...
                if (null === g) console.error("Invalid scroll position");
                else {
                    0 > g && (g = 0);
                    e = function() {
                        b && "pushState" in h.history && h.history.pushState({},
                            "", h.location.toString().replace(/#.*$/, "") + b)
                    };
            ...
            set: function(a, b, c, d) {
                ...
                k.cookie = e.prefix + a + "=" + encodeURIComponent(b) +
                    (void 0 === c ? "" : ";expires=" + c.toUTCString()) + (e.path ? ";path=" + e.path : "") + (e.domain ? ";domain=" + e.domain : "") + (d ? ";samesite=" + d : "") + (e.secure ? ";secure" : "")
            },
            getJson: function(a) {
                a = this.get(a);
                if (!a) return {};
            ...
            set: function(a, b, c) {
                try {
                    ...
                    c && (c = this.getFallbackValue(), c[a] = b,
        ...
        XF.CrossTab = function() {
            ...
            return {
                ...
                runAutoBlocking: function(a, b) {
                    ...
                    a.length && (f++, g || (g = n("xfAutoBlockingJobStatus")), g.show(), b || (b = XF.phrase("processing...")), d("#xfAutoBlockingJobStatus").text(b), m(a))
                },
                runManual: function(c) {
                    ...
                    if (g) {
                        if (null === c) e = null;
                            ...
                            var e = e || [];
                            "number" === typeof c ?
                                e.push(c) : Array.isArray(c) && e.push.apply(e, c)
                        }
                        if (!a) {
                            a = !0;
                            p().show();
                            var f = function(a) {
                                ...
                                l = function() {
                                    Array.isArray(e) && 0 == e.length ? q() : f(e ? e.shift() : null)
                                };
                            l()
                        }
                    }
            ...
            var a = XF.config.css,
                ...
                c = function(c, e, g) {
                    ...
                    var f = [],
                        m = [],
                        h;
                    for (h = 0; h < c.length; h++) b.hasOwnProperty(c[h]) || f.push(c[h]);
                    for (h = 0; h < e.length; h++) a.hasOwnProperty(e[h]) || m.push(e[h]);
                    var k = (f.length ? 1 : 0) + (m.length ? 1 : 0),
                        p = function() {
                            k--;
                            0 == k && g && g()
                        };
                    k ? (f.length && XF.loadScripts(f, function() {
                        ...
                        p()
                    })) : (console.error("No CSS URL so cannot dynamically load CSS"), p()))) : g && g()
                };
            return {
                load: c,
            ...
            extend: function(a, b) {
                ...
                c ? (c = XF.extend(c, b), this._map[a] =
                    c) : (this._toExtend[a] || (this._toExtend[a] = []), this._toExtend[a].push(b))
            },
            ...
            var a = 0,
                b, c = function() {
                    a++;
                    1 == a && (b || (b = d('<span class="globalAction"><span class="globalAction-bar"></span><span class="globalAction-block"><i></i><i></i><i></i></span></span>').appendTo("body")),
            ...
            var a, b, c, f, e, g, l = !1,
                ...
                q = function(m) {
                    ...
                    // q.setHours(0, 0, 0, 0);
                    // b + k > e && (q.getDay(),
                    //     e = p(q, 1), c = p(q, 0), f = p(q, -1), g = p(q, -6));
                    // for (var w = 0; w < h; w++) {
                    //     var n = m[w];
                    //     var r = d(n);
                    //     var x = parseInt(n.getAttribute("data-time"), 10);
                    //     var y = b - x + k;
                    //     var u = n.xfDynType; - 2 > y ? (y = x - (b + k), 60 > y ? "futureMoment" != u && (r.text(XF.phrase("in_a_moment")), n.xfDynType = "futureMoment") : 120 > y ? "futureMinute" != u && (r.text(XF.phrase("in_a_minute")), n.xfDynType = "futureMinute") : 3600 > y ? (x = Math.floor(y / 60), u !== "futureMinutes" + x && (r.text(XF.phrase("in_x_minutes", {
                    //                 "{minutes}": x
                    //             })), n.xfDynType = "futureMinutes" + x)) : x < e ? "latertoday" != u &&
                    //             (r.text(XF.phrase("later_today_at_x", {
                    //                 "{time}": r.attr("data-time-string")
                    //             })), n.xfDynType = "latertoday") : x < p(q, 2) ? "tomorrow" != u && (r.text(XF.phrase("tomorrow_at_x", {
                    //                 "{time}": r.attr("data-time-string")
                    //             })), n.xfDynType = "tomorrow") : (604800 > y || (r.attr("data-full-date") ? r.text(XF.phrase("date_x_at_time_y", {
                    //                 "{date}": r.attr("data-date-string"),
                    //                 "{time}": r.attr("data-time-string")
                    //             })) : r.text(r.attr("data-date-string"))), n.xfDynType = "future")) : 60 >= y ? "moment" !== u && (r.text(XF.phrase("a_moment_ago")), n.xfDynType = "moment") :
                    //         120 >= y ? "minute" !== u && (r.text(XF.phrase("one_minute_ago")), n.xfDynType = "minute") : 3600 > y ? (x = Math.floor(y / 60), u !== "minutes" + x && (r.text(XF.phrase("x_minutes_ago", {
                    //             "{minutes}": x
                    //         })), n.xfDynType = "minutes" + x)) : x >= c ? "today" !== u && (r.text(XF.phrase("today_at_x", {
                    //             "{time}": r.attr("data-time-string")
                    //         })), n.xfDynType = "today") : x >= f ? "yesterday" !== u && (r.text(XF.phrase("yesterday_at_x", {
                    //             "{time}": r.attr("data-time-string")
                    //         })), n.xfDynType = "yesterday") : x >= g ? "week" !== u && (r.text(XF.phrase("day_x_at_time_y", {
                    //             "{day}": XF.phrase("day" +
                    //                 (new Date(1E3 * x)).getDay()),
                    //             "{time}": r.attr("data-time-string")
                    //         })), n.xfDynType = "week") : "old" !== u && (r.attr("data-full-date") ? r.text(XF.phrase("date_x_at_time_y", {
                    //             "{date}": r.attr("data-date-string"),
                    //             "{time}": r.attr("data-time-string")
                    //         })) : r.text(r.attr("data-date-string")), n.xfDynType = "old")
                    // }
                },
                p = function(a, b) {
                ...
                initialize: function() {
                    if (!l) {
                        ...
                        void 0 !== k.hidden ? (k.hidden || h(), d(k).on("visibilitychange", function() {
                            k.hidden ? clearInterval(m) : (h(), q(k))
                        })) : h()
                    }
                },
                refresh: q
            ...
            var a, b, c = !1,
                ...
                l, m = function() {
                    c && (!1 === h.navigator.onLine && (g++, 5 >= g && (l = setTimeout(m, 30))), g = 0, clearTimeout(l), d.ajax({
                        ...
                        "ok" == a.status && (k(a), XF.CrossTab.trigger(b, a))
                    }))
                },
                k = function(a) {
            ...
            return {
                initialize: function() {
                    if (!c &&
                        XF.config.url.keepAlive && XF.config.url.keepAlive.length) {
                        c = !0;
            ...
            var a = function(a) {
                    ...
                    !c || g && g == a.timeStamp ||
                        (b.data("proxy-handler-last", a.timeStamp), d.ajax({
                    ...
                    if (XF.config.enableRtnProtect && !a.isDefaultPrevented()) {
                        ...
                        if (c && (!c.match(/^[a-z]:/i) || c.match(/^https?:/i)) && !b.is("[data-fancybox]")) {
                            if (b.is("[rel~=noopener]")) {
                                var l = XF.browser;
                                if (l.chrome && 49 <= l.version || l.mozilla && 52 <= l.version ||
                                    l.safari && 11 <= l.version) return
                            }
                            if (!(b.closest("[contenteditable=true]").length || (c = XF.canonicalizeUrl(c), (new RegExp("^[a-z]+://" + location.host + "(/|$|:)", "i")).test(c) || g && g == a.timeStamp || (b.data("blank-handler-last", a.timeStamp), l = navigator.userAgent, b = -1 !== l.indexOf("MSIE"), g = -1 !== l.indexOf("Safari") && -1 == l.indexOf("Chrome"), l = -1 !== l.indexOf("Gecko/"), a.shiftKey && l || g && (a.shiftKey || a.altKey) || b)))) {
                                if (g) b = d('<iframe style="display: none" />').appendTo(k.body), g = b[0].contentDocument || b[0].contentWindow.document,
                                    g.__href = c, c = d("<script />", g), c[0].text = "window.opener=null;window.parent=null;window.top=null;window.frameElement=null;window.open(document.__href).opener = null;", g.body.appendChild(c[0]), b.remove();
                                else {
                                    c = h.open(c);
                                    try {
                                        c.opener = null
            ...
            return {
                ...
                initExternalWatcher: function() {
                    d(k).on("click",
                        "a[target=_blank]", b).on("focusin", "a[target=_blank]", function(a) {
                        a = d(this);
            ...
            __construct: function(a, b) {
                ...
                this.$multiBar.attr("role", this.options.role || "dialog").attr("aria-hidden", "true").on("multibar:hide", XF.proxy(this,
                    "hide")).on("multibar:show", XF.proxy(this, "show"));
            ...
            on: function() {
                this.$container.on.apply(this.$container,
                    arguments)
            },
            ...
            var e = function(a) {
                ...
                c.show && a.show();
                c.afterShow && (b = d.Event(),
                    c.afterShow(a, b), b.isDefaultPrevented())
            };
            if (c.cache && XF.loadMultiBar.cache[a]) e(XF.loadMultiBar.cache[a]);
            else {
                var g = function(b) {
                    if (b.redirect)
            ...
            if (b.cache && XF.loadOverlay.cache[a]) f(XF.loadOverlay.cache[a]);
            else {
                var e = function(d) {
                    if (d.redirect)
        ...
        }, XF.loadOverlay.cache = {}, XF.NavDeviceWatcher =
        function() {
            function a(a) {
            ...
            function a(a) {
                if (!q) {
                    ...
                    var c = v;
                    v = a;
                    if (a > c) "down" != t && (t = "down", A = c);
                    else if (a < c) "up" != t && (t = "up", A = c);
                    else return;
                    if (p) {
                        if ("up" !== t || 100 > v) {
                            B && (B.cancel(),
            ...
            function b() {
                n || (z.addClassTransitioned("is-active"), n = !0)
            }

            function c() {
                n && (z.removeClassTransitioned("is-active"), n = !1)
            }
            ...
            function c(a) {
                ...
                if (XF.Keyboard.isShortcutAllowed(k.activeElement) &&
                    (!e.hasOwnProperty(a.key) || 0 != (0 + a.ctrlKey ? 1 : 0 + a.altKey ? 2 : 0 + a.metaKey ? 4 : 0) || !f(e[a.key])) && e.hasOwnProperty(a.which)) {
        ...
        function() {
            ...
            function a() {
                var a = XF.config.serviceWorkerPath;
                null === a && (a = "service_worker.js");
                return a && a.length ? XF.canonicalizeUrl(a) : null
            }
            ...
            function c() {
                m && (XF.ActionIndicator.show(), setTimeout(function() {
            ...
            function e(a, b) {
                if (navigator.serviceWorker.controller)
                    if ("string" !== typeof a || "" === a) console.error("Invalid message type:", a);
                    else {
            ...
            return {
                initialize: function() {
                    XF.PWA.isSupported() && (XF.config.skipServiceWorkerRegistration ? l = new Promise(function(a, b) {
                        b(Error("Service worker registration has been skipped"))
                    }) : (l = navigator.serviceWorker.register(a()), l.then(function(a) {
                        var b = XF.config.cacheKey;
                        a = a.active ? !1 : !0;
                        XF.LocalStorage.get("cacheKey") !== b && (a || e("updateCache"), XF.LocalStorage.set("cacheKey", b, !0))
                    }), l.catch(function(a) {
                        ...
                        var b = a.data;
                        if ("object" !== typeof b || null === b) console.error("Invalid message:", b);
                        else if (a = b.type, b = b.payload,
                            "string" !== typeof a || "" === a) console.error("Invalid message type:", a);
                        else if ("object" !== typeof b || null === b) console.error("Invalid message payload:", b);
                        else {
                            var c = w[a];
                            "undefined" === typeof c ? console.error("No handler available for message type:", a) : c(b)
                        }
                    }), b() && (d(h).on("beforeunload", c), d(k).on("click", ".js-skipPwaNavIndicator", f))))
                },
                isSupported: function() {
                    null === g && (g = !!("serviceWorker" in navigator && a()));
                    return g
                },
                isRunning: b,
        ...
        XF.Push = function() {
            ...
            return {
                ...
                handleSubscribeAction: function(a, b, c) {
                    XF.Push.isSubscribed || Notification.requestPermission().then(function(d) {
                        if ("granted" !== d) console.error("Permission was not granted");
                        else {
                            ...
                            XF.PWA.getRegistration().then(function(d) {
                                d.pushManager.subscribe({
                                    ...
                                    XF.Push.updateUserSubscription(c,
                                        "insert");
                ...
                d(a).find(".js-expandWatch:not(.is-expanded)").each(function() {
                    ...
                    if (b) {
                        ...
                        if (!a.data("expand-check-triggered") && (a.data("expand-check-triggered", !0), a.find("img").one("load", l), h.MutationObserver)) {
                            ...
                            var p = new MutationObserver(function(b) {
                                a.hasClass("is-expanded") ? p.disconnect() :
                                    w && (k && clearTimeout(k), k = setTimeout(q, 200))
                            });
                            p.observe(this, {
                                attributes: !0,
                                childList: !0,
            ...
            function a() {
                function d(a) {
                    ...
                    var c = b.indexOf("\n"); - 1 !== c && (b = b.substring(0,
                        c), g = null === g ? b.length : g + b.length, g++, XF.UnfurlLoader.handleResponse(JSON.parse(b)), g < a.length && d(a))
                }
                if (b.length && !c) {
                    var g = null;
                    c = !0;
                ...
                f = XF.create({
                    ...
                    _onEvent: function(a) {
                        ...
                        if (!b.isDefaultPrevented()) {
                            ...
                            this.$target.trigger("xf-" + this.eventType + ":after-" +
                                this.eventType + "." + this.eventNameSpace, [this, b, a])
                        }
                        return null
                    },
                    init: function() {
            ...
            return {
                watch: function(a) {
                    ...
                    b.hasOwnProperty(a) ||
                        (b[a] = !0, d(k).on(a, "[data-xf-" + a + "]", function(b) {
        ...
        XF.Element = function() {
            ...
            showResults: function(a, b, c, f) {
                ...
                if (b) {
                    ...
                    for (e in b)
                            ...
                            if ("string" == typeof g) {
                                ...
                                for (p in q)
                                    if (q.hasOwnProperty(p)) {
                                        var n = p.match(/Html$/),
                                            v = n ? p.replace(/Html$/, "") : p;
                                        n = n ? q[p] : XF.htmlspecialchars(q[p]);
                                        m[v] = n
                                    }
                            }
                            l.data("insert-text", w);
                        ...
                        this.headerHtml && (l = d("<li />").addClass("menu-header menu-header--small").attr("unselectable",
                            "on").html(this.headerHtml), l.prependTo(this.$results));
            ...
            keydown: function(a) {
                if (this.visible) switch (a.which) {
                    case 40:
                        return this.results.selectResult(1),
                            a.preventDefault(), !1;
                    case 38:
            ...
            blur: function() {
                this.visible && setTimeout(XF.proxy(this,
                    "hide"), 250)
            },
            ...
            show: function(a, b) {
                ...
                if (c)
                    if (this.visible = !0, this.ed) {
                        ...
                        for (var b = d("<div />"), l = h.getComputedStyle(f[0]), m, n = "", v = 0; v < l.length; v++) m = l[v], n += m + ": " + l.getPropertyValue(m) + "; ";
                        b[0].style.cssText = n;
                        b.css({
                            position: "absolute",
                            height: "",
                        ...
                        n.setEnd(b[0].firstChild, c.start + 1 + c.query.length);
                        v = n.getBoundingClientRect();
                        n = e.left + (v.left - t.left);
                        b.remove();
                        return g.getResultPositionForSelection(l, m, n, a,
                            e)
                    })
            },
...
! function(c, g, e, h) {
    ...
    XF.LikeClick = XF.Event.newHandler({
        ...
        init: function() {
            this.options.container && (this.$container =
                XF.findRelativeIf(this.options.container, this.$target))
        },
        click: function(a) {
            a.preventDefault();
            if (!this.processing) {
        ...
        handleAjax: function(a) {
            ...
            b.trigger("xf-" + this.eventType +
                ":after-handleAjax." + this.eventNameSpace, [this, a])
        }
    });
    ...
    XF.handleSwitchResponse = function(a, b, d) {
        if (b.switchKey) {
            var f = a.data("sk-" + b.switchKey),
                k = !1;
            if (f) {
                for (var e, g; e = f.match(/(\s*,)?\s*(addClass|removeClass|titleAttr):([^,]+)(,|$)/);)
                    if (f = f.substring(e[0].length),
                        g = c.trim(e[3]), g.length) switch (e[2]) {
                        case "addClass":
                            a.addClass(g);
                            break;
                        case "removeClass":
    ...
    XF.ScrollToClick = XF.Event.newHandler({
        ...
        init: function() {
            ...
            if (a && a.length)
                if (this.$scroll = a, !0 === b || "true" === b) a = a.attr("id"), this.options.hash =
                    a && a.length ? a : null;
                else {
    ...
    XF.SwitchOverlayClick = XF.Event.newHandler({
        ...
        handleOverlaySubmit: function(a, b) {
            "ok" == b.status && (a.preventDefault(), (a = this.overlay) && a.hide(), XF.handleSwitchResponse(this.$target,
                b, this.options.redirect))
        }
    });
    ...
    XF.Draft = XF.Element.newHandler({
        ...
        init: function() {
            if (this.options.draftUrl) {
                ...
                setInterval(XF.proxy(this,
                    "triggerSave"), 1E3 * this.options.draftAutosave)
    ...
    XF.DraftTrigger = XF.Element.newHandler({
        ...
        init: function() {
            if (XF.isElementWithinDraftForm(this.$target)) {
                ...
                if (this.draftHandler = XF.Element.getHandler(a, "draft")) this.$target.on("keyup", XF.proxy(this,
                    "keyup"))
            }
        },
        keyup: function(a) {
    ...
    XF.Preview = XF.Element.newHandler({
        ...
        preview: function(a) {
            ...
            var b = this;
            XF.ajax("post", this.options.previewUrl,
    ...
    XF.ShareButtons = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.$target.on("focus mouseenter", a, XF.proxy(this,
                "focus")).on("click", a, XF.proxy(this, "click"));
        ...
        setupPageData: function() {
            ...
            this.options.pageImage && this.options.pageImage.length ? this.pageImage = this.options.pageImage :
                (this.pageImage = c('meta[property="og:image"]').attr("content"), this.pageImage || (this.pageImage = XF.config.publicMetadataLogoUrl || ""))
        },
        focus: function(a) {
            ...
            if (!b.attr("href") && !b.is(".shareButtons-button--share")) {
                ...
                d = d.replace("{url}", encodeURIComponent(this.pageUrl)).replace("{title}", encodeURIComponent(this.pageTitle)).replace("{desc}",
        ...
        click: function(a) {
            ...
            b.is(".shareButtons-button--share") || a.altKey || a.ctrlKey || a.metaKey || a.shiftKey || (b.data("clipboard") ? (a.preventDefault(), a = b.data("clipboard").replace("{url}", this.pageUrl).replace("{title}", this.pageTitle).replace("{desc}", this.pageDesc).replace("{image}", this.pageImage),
    ...
    XF.WebShare = XF.Element.newHandler({
        ...
        setupShareData: function() {
            this.fetchUrl || (this.options.url ? this.url = this.options.url : (this.url = c('meta[property="og:url"]').attr("content"), this.url || (this.url = g.location.href)),
                this.options.title ? this.title = this.options.title : (this.title = c('meta[property="og:title"]').attr("content"), this.title || (this.title = c("title").text())), this.options.text ? this.text = this.options.text : (this.text = c('meta[property="og:description"]').attr("content"), this.text || (this.text = c("meta[name=description]").attr("content") || "")))
        },
        click: function(a) {
            a.preventDefault();
            if (this.fetchUrl) {
                ...
                XF.ajax("get", this.fetchUrl, {
                    ...
                    "ok" === a.status ? (b.setShareOptions(a), b.share()) :
    ...
    XF.CopyToClipboard = XF.Element.newHandler({
        ...
        init: function() {
            ...
            if (this.copyText) this.$target.on("click", XF.proxy(this, "click"));
            else console.error("No text to copy to clipboard")
        },
        click: function() {
            var a = this;
            navigator.clipboard.writeText(this.copyText).then(function() {
                if (a.options.success) XF.flashMessage(a.options.success,
                    3E3);
                else {
    ...
    XF.PushToggle = XF.Element.newHandler({
        ...
        cancellingSub: null,
        init: function() {
            XF.Push.isSupported() ? "denied" === Notification.permission ? (this.updateButton(XF.phrase("push_blocked_label"), !1), console.error("Notification.permission === denied")) : this.registerWorker() : (this.updateButton(XF.phrase("push_not_supported_label"),
                !1), console.error("XF.Push.isSupported() returned false"))
        },
    ...
    XF.PushCta = XF.Element.newHandler({
        ...
        registerWorker: function() {
            ...
            XF.Push.registerWorker(function() {
                c(e).on("push:init-unsubscribed", function() {
                    ...
                    } else a.getDismissCookie() || a.$target.closest(".js-enablePushContainer").xfFadeDown(XF.config.speed.fast,
        ...
        setDismissCookie: function(a, b) {
            a ? (b || (b = 31536E7), XF.Cookie.set("push_notice_dismiss",
                "1", new Date(Date.now() + b))) : XF.Cookie.set("push_notice_dismiss", "1")
        },
    ...
    XF.Reaction = XF.Element.newHandler({
        ...
        getContent: function() {
            var a = this.href;
            a =
                a.replace(/(\?|&)reaction_id=[^&]*(&|$)/, "$1reaction_id=");
        ...
        onHide: function() {
            XF.Reaction.activeTooltip ===
                this && (XF.Reaction.activeTooltip = null);
        ...
        actionClick: function(a) {
            a.preventDefault();
            if (this.$target.data("tooltip:taphold") && this.$target.is(a.currentTarget)) this.$target.removeData("tooltip:taphold");
        ...
        actionComplete: function(a) {
            if (a.html) {
                ...
                XF.setupHtmlInsert(a.html, function(a, c, h) {
                    ...
                    f ? (b.addClass("has-reaction"), b.removeClass("reaction--imageHidden"), d && b.removeClass("reaction--" + d),
                        b.addClass("reaction--" + f), b.data("reaction-id", f)) : (b.removeClass("has-reaction"), b.addClass("reaction--imageHidden"), d && (b.removeClass("reaction--" + d), b.addClass("reaction--" + a.data("reaction-id")), b.data("reaction-id", 0)));
                    k.replaceWith(c);
                    m && h && m.replaceWith(h)
                });
    ...
    XF.BookmarkClick = XF.Event.newHandler({
        ...
        handleSwitchClick: function(a) {
            var b = this,
                c = function() {
                    XF.handleSwitchResponse(b.$target,
                        a);
    ...
    XF.ContentVote = XF.Element.newHandler({
        ...
        updateDisplay: function(a, b) {
            ...
            c.fadeOut("fast", function() {
                c.attr("data-score",
                    b.voteScore).text(b.voteScoreShort);
    ...
    XF.Event.register("click",
        "attribution", "XF.AttributionClick");
    ...
    XF.Element.register("focus-trigger",
        "XF.FocusTrigger");
    ...
    XF.Element.register("bookmark-click",
        "XF.BookmarkClick");
...
! function(c, l, g) {
    ...
    XF.AjaxSubmit = XF.Element.newHandler({
        ...
        enableButtons: function() {
            this.$target.find(this.options.disableSubmit).prop("disabled",
                !1)
        },
        submitResponse: function(a, b, d) {
            if ("object" != typeof a) XF.alert("Response was not JSON.");
                ...
                if (!e.isDefaultPrevented()) {
                    ...
                    if (a.errorHtml) b.trigger(e,
                        a, this), e.isDefaultPrevented() || XF.setupHtmlInsert(a.errorHtml, function(a, b) {
                        b = b.h1 || b.title || XF.phrase("oops_we_ran_into_some_problems");
                        XF.overlayMessage(b, a)
                    }), f = !0;
                    else if (a.errors) b.trigger(e, a, this), e.isDefaultPrevented() || XF.alert(a.errors), f = !0;
                    else if (a.exception) XF.alert(a.exception);
                    else if ("ok" == a.status && a.message) m ? this.options.forceFlashMessage ? (XF.flashMessage(a.message, 1E3, function() {
                            XF.redirect(a.redirect)
                        }), h = !0) : XF.redirect(a.redirect) : (XF.flashMessage(a.message, 3E3), h = !0), k &&
                        k.trigger("overlay:hide");
                    else if (a.html) {
                        var g = this;
                    ...
                    b.trigger(e, a, this);
                    e.isDefaultPrevented() || this.options.resetComplete &&
                        !f && b[0].reset()
                }
            }
        },
        doSubmitReplace: function(a, b) {
            ...
            d = c.trim(e[0]);
            e = e[1] ? c.trim(e[1]) : d;
            if ("self" == d || this.$target.is(d)) var f = this.$target;
            else f = this.$target.find(d).first(), f.length || (f = c(d).first());
            ...
            this.options.showReplacement ? (h.hide().insertAfter(f),
                f.xfFadeUp(null, function() {
                    f.remove();
    ...
    XF.AutoComplete = XF.Element.newHandler({
        ...
        init: function() {
            ...
            a.closest("form").submit(XF.proxy(this,
                "hideResults"))
        },
        keydown: function(a) {
        ...
        keyup: function(a) {
            ...
            this.loadTimer = setTimeout(XF.proxy(this,
                "load"), 200)
        },
        blur: function(a) {
    ...
    XF.SelectPlus = XF.Element.newHandler({
        ...
        init: function() {
            ...
            if (this.$containers.length != this.$checkboxes.length) console.error("There must be an equal number of checkboxes and containers");
                ...
                this.$checkboxes.on("click", XF.proxy(this,
                    "checkboxClick")).closest("label").hover(XF.proxy(this, "checkboxEnter"), XF.proxy(this, "checkboxExit"));
                c(g).onPassive({
                    keydown: XF.proxy(this, "keydown"),
                    keyup: XF.proxy(this, "keyup")
                });
        ...
        checkboxClick: function(a) {
            if (!this.ignoreClick) {
                this.debug("checkboxClick; delegateTarget: %o",
                    a.delegateTarget);
        ...
        checkboxEnter: function(a) {
            this.isActive && (this.lastEntered = this.$checkboxes.index(c(a.delegateTarget).find("input:checkbox").eq(0)),
        ...
        redrawSelected: function() {
            ...
            this.$checkboxes.each(function(b) {
                var d = c(this),
                    e = d.is(":checked");
                b = a.$containers.eq(b);
                b.toggleClassTransitioned(a.options.checkedClass,
                    e);
        ...
        redrawHover: function() {
            ...
            if (null !== this.lastSelected && null !== this.lastEntered && this.isShifted) {
                ...
                a.toggleClassTransitioned(this.options.hoverClass,
                    !0)
        ...
        debug: function() {
            this.options.spDebug && (arguments[0] = "SelectPlus:" + arguments[0], console.log.apply(null,
                arguments))
        }
    });
        ...
        XF.Element.newHandler({
            ...
            recalculate: function(a, b) {
                ...
                e.is(":enabled") && (e.is(":checked") && !this.options.invert || this.options.invert && !e.is(":checked")) ? (d.prop("disabled", !1).removeClass("is-disabled"), f.prop("disabled", !1).removeClass("is-disabled").each(function(a, b) {
                    ...
                    XF.layoutChange();
                    k()
                }), d.trigger("toggle:shown"), XF.layoutChange()) : a || k()) : (this.options.hide && (a ? d.hide() : d.slideUp(h, XF.layoutChange), d.trigger("toggle:hidden"),
                    XF.layoutChange()), d.prop("disabled", !0).addClass("is-disabled"), f.prop("disabled", !0).addClass("is-disabled").trigger("control:disabled").each(function(a, b) {
                    a = c(b);
                    b = a.data("disabled");
    ...
    XF.FormSubmitRow = XF.Element.newHandler({
        ...
        init: function() {
            if (XF.config.enableFormSubmitSticky) {
                ...
                b.length ? (this.$container = b, this.topOffset = this.options.topOffset, this.$fixEl = a.find(this.options.fixedChild), c(l).on("scroll", XF.proxy(this, "onScroll")).on("resize", XF.proxy(this, "recalcAndUpdate")), b = XF.getFixedOffsetParent(a), b.is("html") || (this.$fixedParent = b, b.on("scroll", XF.proxy(this, "onScroll"))), c(g.body).on("xf:layout",
                    XF.proxy(this, "recalcAndUpdate")), a.height() || setTimeout(XF.proxy(this, "recalcAndUpdate"), 250), this.recalcAndUpdate()) : console.error("Cannot float submit row, no container")
            }
        },
        recalc: function() {
            var a = this.$target;
        ...
        update: function() {
            ...
            if (a < this.options.minWindowHeight) "normal" != this.state && (this.resetTarget(), this.state = "normal");
                ...
                var b = XF.NoticeWatcher.getBottomFixerNoticeHeight() ||
                    0;
                a = this.getScrollTop() + a - b;
                if (a >= this.elBottom) "normal" != this.state && (this.resetTarget(), this.state = "normal");
                else {
        ...
        setTargetSticky: function(a) {
            this.$target.toggleClass(this.options.stickyClass,
                a).css("height", this.$fixEl.height())
        },
        onScroll: function() {
            this.update()
        }
    ...
    XF.TextAreaHandler = XF.Element.newHandler({
        ...
        initialized: !1,
        init: function() {
            this.options.autoSize && (this.$target[0].scrollHeight ? this.setupAutoSize() : (this.$target.one("focus control:enabled control:disabled",
                XF.proxy(this, "setupDelayed")), this.$target.onWithin("toggle:shown overlay:shown tab:shown quick-edit:shown", XF.proxy(this, "setupDelayed"))), this.$target.on("autosize", XF.proxy(this, "update")));
    ...
    XF.PermissionMatrix = XF.Element.newHandler({
        ...
        update: function() {
            ...
            var a = this.$target.find(this.options.inputSelector + ":checked").val(); - 1 < c.inArray(a, this.values) && (this.currentClass =
                this.options.classPrefix + this.options.permissionType + "-" + a, this.$parentRow.addClass(this.currentClass))
        }
    });
    XF.MultiCheck = XF.Event.newHandler({
        ...
        click: function(a) {
            var b =
                this.values[c.inArray(this.currentValue, this.values) + 1];
    ...
    XF.NumberBox = XF.Element.newHandler({
        ...
        createButton: function(a) {
            a = c("<button />").attr("type", "button").attr("tabindex", "-1").addClass("inputGroup-text").addClass("inputNumber-button").addClass("inputNumber-button--" + a).addClass("js-" + a).attr("data-dir", a).attr("title",
                XF.phrases["number_button_" + a] || a).attr("aria-label", XF.phrases["number_button_" + a] || a);
    ...
    XF.PasswordHideShow = XF.Element.newHandler({
        ...
        toggle: function(a) {
            a = this.$password;
            var b = this.$label;
            this.$checkbox.is(":checked") ? (a.attr("type",
                "text"), b.html(this.options.hideText)) : (a.attr("type", "password"), b.html(this.options.showText))
        }
    });
    XF.InputValidator = XF.Element.newHandler({
        ...
        performValidation: function(a) {
            ...
            if (a !== this.validatedValue)
                if ("" !== a || this.options.validateEmpty) this.validatedValue = a, XF.ajax("POST", XF.canonicalizeUrl(this.options.validationUrl), {
            ...
            if (!a.validatedValue ||
                ...
                if (!a.inputValid && b) {
                    if ("object" == typeof b)
                        ...
                        else d = "<ul>", c.each(b, function(a, b) {
                            d += "<li>" + b + "</li>"
                        }), d += "</ul>";
                    else d = b;
    ...
    XF.Element.register("select-plus",
        "XF.SelectPlus");
...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function(d, g, k) {
    d instanceof String && (d = String(d));
    for (var a = d.length, b = 0; b < a; b++) {
        var c = d[b];
        if (g.call(k, c, b, d)) return {
            i: b,
            v: c
        }
    }
...
$jscomp.ASSUME_NO_NATIVE_MAP = !1;
$jscomp.ASSUME_NO_NATIVE_SET = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(d, g, k) {
    d != Array.prototype && d != Object.prototype && (d[g] = k.value)
};
$jscomp.getGlobal = function(d) {
    return "undefined" != typeof window && window === d ? d : "undefined" != typeof global && null != global ? global : d
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(d, g, k, a) {
    if (g) {
        k = $jscomp.global;
        d = d.split(".");
        for (a = 0; a < d.length - 1; a++) {
        ...
        a = k[d];
        g = g(a);
        g != a && null != g && $jscomp.defineProperty(k, d, {
            configurable: !0,
            writable: !0,
            value: g
        })
...
! function(d, g, k) {
    ...
    XF.Inserter = XF.create({
        ...
        onLoad: function(a) {
            if (a.html) {
                var b = this,
                    ...
                    d = c.afterLoad,
                    f;
                e && (f = XF.findRelativeIf(e, this.$target));
                XF.setupHtmlInsert(a.html, function(e, h, f) {
                    b._applyChange(e, c.after, XF.proxy(b, "_applyAfter"));
                    b._applyChange(e, c.append, XF.proxy(b,
                        "_applyAppend"));
                ...
                XF.layoutChange();
                f && f.length && f[0].scrollIntoView(!0)
            }
        },
        _applyChange: function(a, b, c) {
            if (b && b.length) {
                b = b.split(",");
                for (var e, h, f, g = 0; g < b.length; g++) e = b[g].split(" with "), h = d.trim(e[0]), f = e[1] ? d.trim(e[1]) : h, h.length && f.length && (e = d(h).first(), f = a.is(f) ? a : a.find(f).first(), c(h, e, f))
            }
        },
        _applyAfter: function(a,
            b, c) {
        ...
        _applyReplace: function(a, b, c) {
            b.length && (a = this.options.animateReplace, XF.isIOS() && (a = !1), c.length && (a &&
                c.hide(), c.insertAfter(b)), a ? b.xfFadeUp(null, function() {
                b.remove();
    ...
    XF.MenuClick = XF.Event.newHandler({
        ...
        init: function() {
            ...
            if (this.$menu.length) {
                ...
                if (this.options.menuPosRef) {
                    var a = XF.findRelativeIf(this.options.menuPosRef,
                        this.$target);
        ...
        open: function(a) {
            ...
            if (!this.isOpen() && !b.hasClass("is-disabled")) {
                ...
                var f = this;
                this.$target.hasFixableParent() && (this.scrollFunction =
                    function() {
                        c.is(":hidden") ? f.close() : f.repositionFixed(!0)
                    }, b.addClass("menu--potentialFixed"), d(g).onPassive("scroll", this.scrollFunction));
                if (this.options.zIndexRef) {
                    var l = XF.findRelativeIf(this.options.zIndexRef, c);
                    l.length && (h = XF.getElEffectiveZIndex(l))
                }
                XF.setRelativeZIndex(b, c, 0, h);
                    ...
                    if (!b.data("menu-loading")) {
                        ...
                        XF.ajax("get", b.data("href"), {}, function(a) {
                            ...
                            a.html && XF.setupHtmlInsert(a.html, function(a, c,
                                ...
                                f.$target.trigger("menu:loaded", [a, b]);
                                f.updateMenuDimensions();
                                e();
                                setTimeout(XF.proxy(f, "reposition"), 0);
                                f.$target.trigger("menu:complete", [b]);
        ...
        repositionFixed: function(a) {
            ...
            if (a && XF.isIOS()) {
                ...
                if (e && this.menuRef.left == e[0] && this.menuRef.width == e[1]) {
                    e = d(g).viewport();
                    var h = this.$target.hasFixedParent() ? "fixed" : "absolute",
                        f = {
                            top: parseInt(b.css("top"), 10)
                        };
                    this.menuIsUp = this.$menu.hasClass("menu--up");
                    a && clearTimeout(a);
                    "fixed" == h && h != b.css("position") ? (f = {
                        "transition-property": "none",
                        "transition-duration": "0s"
                    }, f = this.getVerticalFixedPosition(e, f)) : "absolute" == h && (f = {
                        "transition-property": "none",
                        "transition-duration": "0s"
                    }, f = this.getVerticalAbsolutePosition(e,
                        f));
                    b.css(f).toggleClass("menu--up", this.menuIsUp);
                    a = setTimeout(function() {
                        b.css({
                            "transition-property": "",
                            "transition-duration": ""
        ...
        getHorizontalPosition: function(a, b) {
            var c = !1,
                e = 0;
            this.menuWidth > a.width ? e = this.menuRef.left - a.left : this.menuRef.left + this.menuRef.width / 2 > a.width * this.options.directionThreshold ? (e = 0 - this.menuWidth + this.menuRef.width, c = !0) : this.menuRef.width > this.menuWidth && (e = Math.floor((this.menuRef.width - this.menuWidth) /
                2));
        ...
        getVerticalPosition: function(a, b, c) {
            this.menuIsUp = !1;
            b = !c && this.$target.hasFixedParent() ?
                this.getVerticalFixedPosition(a, b) : this.getVerticalAbsolutePosition(a, b);
        ...
        close: function() {
            if (this.isOpen()) {
                ...
                d(g).offPassive("scroll", this.scrollFunction);
    ...
    XF.MenuWatcher =
        function() {
            ...
            return {
                onOpen: function(c, e) {
                    b || (b = d('<div class="menuOutsideClicker" />').on("click", h).insertBefore(c));
                    a.length || (d(k).on("click", h), d(g).onPassive("resize", f), e && b.addClass("is-active"));
                    a = a.add(c)
                },
                onClose: function(c) {
                    a =
                        a.not(c);
                    a.length || (d(k).off("click", h), d(g).offPassive("resize", f), b && b.removeClass("is-active"));
                    l(c)
                },
                closeAll: function() {
                    c = !0;
    ...
    XF.MenuProxy = XF.Event.newHandler({
        ...
        init: function() {
            ...
            if (!this.$trigger ||
                !this.$trigger.length) throw Error("Specified menu trigger not found");
        },
        click: function(a) {
    ...
    XF.OffCanvasClick = XF.Event.newHandler({
        ...
        init: function() {
            ...
            if (this.$menu.length) {
                this.$menu.on("click",
                    "[data-menu-close]", XF.proxy(this, "closeTrigger")).on("off-canvas:close", XF.proxy(this, "closeTrigger")).on("off-canvas:open", XF.proxy(this, "openTrigger"));
    ...
    XF.OffCanvasBuilder = {
        navigation: function(a, b) {
            ...
            d(".js-offCanvasNavSource .p-navEl").each(function() {
                var a = d(this),
                    ...
                    f = a.find(".p-navEl-link"),
                    g = a.find("[data-menu]");
                a.data("has-children") && !g.length && (a = a.find('[data-xf-click~="menu"]').first().data("xf-click-handlers")) && a.menu && (g = a.menu.$menu);
                if (f.length) {
                    ...
                    a.html(k);
                    b && (f.addClass("is-selected"), a.addClass("is-selected"));
                    f.html(a);
                    if (g.length) {
                        ...
                        g.find(".menu-linkRow").each(function() {
                            var a = d(this),
                                b = d("<li />");
        ...
        sideNav: function(a, b) {
            ...
            d(g).onPassive("resize", function() {
                e.is(":visible") ||
                    a.trigger("off-canvas:close")
            })
        },
        simple: function(a, b) {
            a.appendTo("body");
    ...
    XF.OverlayClick = XF.Event.newHandler({
        ...
        init: function() {
            ...
            if (a) this.setupOverlay(new XF.Overlay(a, this.options.overlayConfig));
            else {
                a = this.getLoadUrl();
        ...
        toggle: function() {
            this.overlay ? this.overlay.toggle() :
                this.show()
        },
        show: function() {
    ...
    XF.ToggleClick = XF.Event.newHandler({
        ...
        loading: !1,
        init: function() {
            this.$toggleTarget = XF.getToggleTarget(this.options.target,
                this.$target);
        ...
        hide: function(a) {
            if (this.isVisible() && !this.isTransitioning()) {
                ...
                this.$toggleParent && this.$toggleParent.removeClassTransitioned(b, this.inactiveTransitionComplete,
                    a);
                this.$toggleTarget && this.$toggleTarget.removeClassTransitioned(b, this.inactiveTransitionComplete, a);
                this.$target.removeClassTransitioned(b, this.inactiveTransitionComplete, a)
            }
        },
        show: function(a) {
            if (!this.isVisible() && !this.isTransitioning() && !this.getOtherToggles().filter(".is-transitioning").length)
                if (this.toggleUrl && !this.ajaxLoaded) this.load();
                    ...
                    this.$toggleTarget &&
                        this.$toggleTarget.addClassTransitioned(b, this.activeTransitionComplete, a);
        ...
        getContainer: function() {
            if (this.options.container) {
                var a =
                    this.$target.closest(this.options.container);
    ...
    XF.ToggleStorage = XF.Element.newHandler({
        ...
        init: function() {
            ...
            if (!this.storage) throw Error("Invalid storage type " +
    ...
    XF.ToggleStorageDataInstance = XF.create({
        ...
        get: function(a, b, c) {
            ...
            if (!e && c[0] + c[1] < f) return delete this.dataCache[a][b],
                this.scheduleSync(a), null;
            d && (c[0] = f, this.dataCache[a][b] = c, this.scheduleSync(a));
            return c[2]
        },
        ...
        prune: function(a, b) {
            ...
            b ? d() : c ||
                (this.pruneTimers[a] = setTimeout(d, 100))
        },
        ...
        syncToStorage: function(a) {
            if (this.dataCache[a]) {
                var b =
                    this.dataCache[a];
                if (d.isEmptyObject(b)) this.storage.remove(a);
    ...
    XF.ToggleStorageData = function() {
        ...
        return {
            ...
            set: function(a, d, h, f) {
                return b.set(a, d, h, f)
            },
            remove: function(a,
                d) {
                return b.remove(a, d)
    ...
    XF.HScroller = XF.Element.newHandler({
        ...
        init: function() {
            var a =
                this.$target.find("." + this.options.scrollerClass).first();
            if (a.length) {
                this.$scrollTarget = a;
                var b, c, e = this;
                a.on("mousedown.horizontalScroller", function(a) {
                    a.button || (b = a.clientX, c = !1, a.preventDefault(), XF.isEventTouchTriggered(a) && (a = d(k.activeElement), a.is(":input") && a.blur()), d(g).on("mouseup.horizontalScroller", function(a) {
                        d(g).off(".horizontalScroller");
                        c && a.preventDefault()
                ...
                var h = XF.measureScrollBar(null, "height");
                a.addClass("is-calculated");
                0 != h && a.css("margin-bottom", parseInt(a.css("margin-bottom"), 10) - h + "px");
                h = this.options.actionClass;
                this.$goStart = d('<i class="' + h + " " + h + '--start" aria-hidden="true" />').click(function() {
                    e.step(-1)
                }).insertAfter(a);
                this.$goEnd = d('<i class="' +
                    h + " " + h + '--end" aria-hidden="true" />').click(function() {
                    e.step(1)
                }).insertAfter(a);
                this.updateScroll();
                d(k.body).on("xf:layout", XF.proxy(this, "updateScroll"));
                var f;
                d(g).on("resize", function() {
                    f && clearTimeout(f);
                    f = setTimeout(XF.proxy(e, "updateScroll"), 100)
                });
                ...
                if (l.length) {
                    ...
                    m = m.left;
                    l = m + l;
                    XF.isRtl() ? 80 > m && a.normalizedScrollLeft(-l + h - 50) : l > h && (l + 80 > h ? a.normalizedScrollLeft(m - 50) : a.normalizedScrollLeft(m -
                        80))
                }
    ...
    XF.ResponsiveDataList = XF.Element.newHandler({
        ...
        processRow: function(a, b) {
            ...
            a.find(this.options.rowCells).each(function() {
                ...
                if (b) {
                    var f = e[c];
                    f && f.length && !a.data("hide-label") ? a.attr("data-cell-label", f) : a.removeAttr("data-cell-label")
    ...
    XF.StickyHeader = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.stickyBroken = b;
            this.update();
            d(g).on("resize.sticky-header", XF.proxy(this, "update"));
            XF.StickyHeader.cache.push(this)
        },
        update: function() {
            (this.windowTooSmall = d(g).height() < this.options.minWindowHeight) ? !1 !== this.active && this._disable(): this.active || this._enable()
        },
        _enable: function() {
            this.active = !0;
            var a = this.$target,
            ...
            if (this.supportsSticky) {
                var e = !1,
                    h = parseInt(a.css("top"), 10),
                    f = XF.isIOS(),
                    k, m = function(c) {
                        var d = Math.floor(a[0].getBoundingClientRect().top);
                        d < h || d == h && 0 < g.scrollY ? e || (a.addClass(b), XF.layoutChange(), e = !0) : e && (f && c ? (clearTimeout(k), k = setTimeout(function() {
                            m(!1)
                        }, 200)) : (a.removeClass(b), XF.layoutChange(), e = !1))
                    };
                d(g).on("scroll.sticky-header", function() {
                    m(!0)
                });
                m(!1)
        ...
        _disable: function() {
            ...
            this.supportsSticky ? d(g).off("scroll.sticky-header") : a.trigger("sticky_kit:detach").removeData("sticky_kit");
    ...
    XF.Tabs = XF.Element.newHandler({
        ...
        init: function() {
            ...
            a = this.options.panes ?
                XF.findRelativeIf(this.options.panes, a) : a.next();
            a.is("ol, ul") && (a = a.find("> li"));
            this.$panes = a;
            if (b.length != a.length) console.error("Tabs and panes contain different totals: %d tabs, %d panes", b.length, a.length), console.error("Tabs: %o, Panes: %o", b, a);
            else {
                ...
                d(g).on("hashchange", XF.proxy(this, "onHashChange"));
                d(g).on("popstate", XF.proxy(this, "onPopState"));
                this.reactToHash()
            }
        },
        getSelectorFromHash: function() {
            var a = "";
            if (1 < g.location.hash.length) {
                var b = g.location.hash.replace(/[^a-zA-Z0-9_-]/g, "");
                b && b.length && (a = "#" + b)
            }
            return a
        },
        ...
        activateTab: function(a) {
            var b = this.$tabs.eq(a),
                c = this.$panes.eq(a),
                e = this.options.activeClass;
            b.length && c.length ? (this.$tabs.filter("." + e).removeClass(e).attr("aria-selected", "false").trigger("tab:hidden"), this.$panes.filter("." + e).removeClass(e).attr("aria-expanded", "false").trigger("tab:hidden"), b.addClass(e).attr("aria-selected",
                "true").trigger("tab:shown"), c.addClass(e).attr("aria-expanded", "true").trigger("tab:shown"), XF.layoutChange(), c.data("href") && !c.data("tab-loading") && (c.data("tab-loading", !0), XF.ajax("get", c.data("href"), {}, function(a) {
                c.data("href", !1);
                if (a.html) {
                    var b = c.data("load-target"),
                        e = c.data("source-selector");
                    e && (a.html.content = d(a.html.content).find(e));
                    b ? XF.setupHtmlInsert(a.html, c.find(b)) : XF.setupHtmlInsert(a.html, c)
                }
            }).always(function() {
                c.data("tab-loading", !1)
            }))) : console.error("Selected invalid tab " +
                a)
        },
        tabClick: function(a) {
            var b = a.currentTarget,
            ...
            if (-1 == c) console.error("Did not find clicked element (%o) in tabs", b);
                ...
                if (!e.isDefaultPrevented()) {
                    ...
                    if (this.options.state) switch (a = g.location.href.split("#")[0], b.attr("id") ? (a = a + "#" + b.attr("id"), b = {
                            id: b.attr("id")
                        }) : b = {
                            offset: c
                        }, this.options.state) {
                        case "replace":
                            g.history.replaceState(b, "", a);
                            break;
                        case "push":
                            g.history.pushState(b,
                                "", a)
                    }
                    this.activateTab(c)
                }
    ...
    XF.TouchProxy = XF.Element.newHandler({
        ...
        init: function() {
            var a = this;
            if ("InputDeviceCapabilities" in g || "sourceCapabilities" in UIEvent.prototype) this.$target.click(function(b) {
                var c = b.originalEvent;
                c && c.sourceCapabilities && c.sourceCapabilities.firesTouchEvents &&
                    a.handleTapEvent(b)
            });
    ...
    XF.ShifterClick = XF.Event.newHandler({
        ...
        click: function(a) {
            "down" ==
            this.options.dir ? this.$element.insertAfter(this.$element.next()) : this.$element.insertBefore(this.$element.prev())
        }
    });
    XF.VideoInit = XF.Element.newHandler({
        ...
        hasSeeked: function() {
            ...
            if (a) {
                var g = this;
                a.toBlob(function(a) {
                    a && (a = URL.createObjectURL(a), g.$target.attr("poster", a))
                })
            }
        }
    });
    XF.RemoverClick = XF.Event.newHandler({
        ...
        click: function(a) {
            this.$targetElement.length && (this.$targetElement.remove(),
                XF.layoutChange())
        }
    });
    XF.DuplicatorClick = XF.Event.newHandler({
        ...
        click: function(a) {
            this.$targetElement.length && (a = this.$targetElement.clone(!0).insertAfter(this.$targetElement), XF.layoutChange(), this.$targetElement.closest("[data-xf-init~=list-sorter]").length && d(g).trigger("listSorterDuplication", a))
        }
    });
    XF.Event.register("click", "inserter",
        "XF.InserterClick");
    ...
    XF.Event.register("click", "duplicator",
        "XF.DuplicatorClick");
...
! function(d, k, e) {
    XF.TooltipElement = XF.create({
        ...
        reposition: function() {
            ...
            if (!a) console.error("No tooltip positioner");
                ...
                b = a.outerWidth();
                l = a.outerHeight();
                "top" == h && c.top - l < f.top ? h = "bottom" : "bottom" ==
                    h && c.bottom + l > f.bottom ? c.top - l >= f.top && (h = "top") : "left" == h && c.left - b < f.left ? h = c.right + b > f.right ? c.top - l < f.top ? "bottom" : "top" : "right" : "right" == h && c.right + b > f.right && (h = c.left - b < f.left ? c.top - l < f.top ? "bottom" : "top" : "left");
                ...
                if ("left" == h || "right" == h) g.top < f.top ? c = f.top - g.top : g.bottom > f.bottom && (c = f.bottom - g.bottom), m.css({
                    ...
                    var n = parseInt(a.css("padding-right"),
                        10);
                    p < g ? (b = g - p, a.css({
    ...
    XF.TooltipTrigger = XF.create({
        ...
        init: function() {
            ...
            if (!b && this.options.clickHide) a.onPointer("click.tooltip auxclick.tooltip contextmenu.tooltip", function(a) {
                c && XF.isEventTouchTriggered(a) || (d.hide(), d.stopFocusBefore =
                    Date.now() + 2E3)
            });
            a.on({
        ...
        clickShow: function(a) {
            ...
            setTimeout(function() {
                ...
                else d(e).on("click.tooltip-" + b.$target.xfUniqueId(), XF.proxy(b, "docClick"))
            }, 0);
            this.show()
        },
        addCovers: function() {
            ...
            a = d();
            for (var c,
                    h = 0; h < b.length; h++) c = d('<div class="tooltipCover" />').css(b[h]), a = a.add(c);
        ...
        enter: function() {
            if (!this.isShown() || !this.clickTriggered) {
                ...
                var a = this.tooltip.requiresLoad() ? this.options.delayInLoading :
    ...
    XF.Tooltip = XF.Element.newHandler({
        ...
        getContent: function() {
            ...
            a.attr("aria-label") || a.attr("aria-labelledby") || d.trim(a[0].textContent).length || a.attr("aria-label", b);
            return b
        },
        refresh: function() {
        ...
        init: function() {
            ...
            if (!this.options.noTouch || !XF.Feature.has("touchevents")) {
                ...
                if (a) {
                    ...
                    c.length ? (this.$element = c, this.$target.removeAttr("title"), this.options.html = !0, this._init()) : b &&
